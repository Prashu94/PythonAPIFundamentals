...
class DataAccessLayer:
    ...
    line_items = Table('items', metadata,
...
def prep_db():
    ...
    inventory_list = [
        ...
        {
            'cookie_name':'oatmeal_rasin',
            'cookie_recipe_url':'http://some.okay.me/cookie/rasin.html',
            'cookie_sku':'EWW01',
            'quantity':'100',
            'unit_cost':'1.00'
        }
    ...
    ins = insert(dal.orders).values(user_id=2, order_id='o1001')
    dal.connection.execute(ins)
    ins = insert(dal.line_items)
    order_items=[
        {
